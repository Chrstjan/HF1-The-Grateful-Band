...
let bandMembersArray = [
  ...
  },
  {
    ...
    description:
      "Brett Sayles, The co-creater and guitarist for The Grateful, is the architect of the band's rich, intricate soundscapes. Known for his exceptional skill and creativity, Brett's guitar work ranges from delicate acoustic strumming to explosive electric solos,",
  },
  {
    name: "Jc Siller",
    role: "Drummer",
    ...
    description:
      "JC Siller, the powerhouse drummer of The Grateful, provides the rhythmic backbone that drives the band's energetic performances. Known for his impeccable timing and dynamic drumming style, JC brings a powerful, infectious energy to every song.",
  },
  {
    name: "Oleg Magni",
    role: "Bassist",
